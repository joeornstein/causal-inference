...
%\chead{ \fancyplain{}{} }
\rhead{ \fancyplain{}{Spring 2026} }%\today
...
\begin{document}
\begin{center}
{\Large \textsc{POLS 8525: Causal Inference}}
\end{center}
\begin{center}
{\large Spring 2026}
\end{center}
...
\textbf{Professor:} & Joe Ornstein & & &  & \textbf{Time:} & Th 2:55pm -- 5:35pm \\
...
\subsection*{Week 2: D'ya Like DAGs?}

\textit{Required Reading:}

\begin{itemize}
	\item NHK Chapters 1-4 (just skim for review)
...
\subsection*{Weeks 3--4: Experiments (Natural and Unnatural)}
...
\subsection*{Weeks 5--6: Selection on Observables (Regression and Matching)}
...
\subsection*{Weeks 7--8: Fixed Effects}
...
\subsection*{Weeks 9--10: Difference-in-Differences}
...
\subsection*{Weeks 11--12: Instrumental Variables}
...
\subsection*{Week 13--14: Regression Discontinuity}
...
\begin{itemize}
	...
	\item Arel-Bundock, Vincent, Ryan C. Briggs, Hristos Doucouliagos, Marco M. Aviña, and T. D. Stanley. “Quantitative Political Science Research Is Greatly Underpowered.” \textit{The Journal of Politics} 88, no. 1 (2026): 36–46. https://doi.org/10.1086/734279.
\end{itemize}


\section*{Academic Honesty}

Remember that when you joined the University of Georgia community, you agreed to abide by a code of conduct outlined in the academic honesty policy called \href{https://honesty.uga.edu/Academic-Honesty-Policy/Introduction/}{\textit{A Culture of Honesty}}. For this class, I do not place restrictions on the use of language models like ChatGPT; these resources can be quite helpful when writing code. 
