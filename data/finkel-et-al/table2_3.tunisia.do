...
************** AIM: This do-file replicates Table 2 AJPS -- Finkel, Neundorf, Rascon-Ramirez 2022
...
**** Aggregated treatment dummies
		...
		* Table 2 in Manuscript
		...
		local m =r(mean)
			outreg2 using "$tables/table2_tunisia_part1.xls", ///
		...
		* Table 3 in Manuscript		
		...
		local m =r(mean)
			outreg2 using "$tables/table2_tunisia_part2.xls", ///
